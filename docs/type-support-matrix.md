...
| `List<Long>`    | ✅ | ✅ | `std::vector<int64_t>`      | `jobject` | `extract_list_long`     | —                  |
| `List<Float>`   | ✅ | ✅ | `std::vector<float>`        | `jobject` | `extract_list_float`    | —                  |
| `List<Double>`  | ✅ | ✅ | `std::vector<double>`       | `jobject` | `extract_list_double`   | —                  |
| `List<Boolean>` | ⏳ | ⏳ | —                           | —         | —                       | —                  |
| `List<Byte>`    | ⏳ | ⏳ | —                           | —         | —                       | —                  |
...
| `Enum`                    | ❌ | ❌ | Could be mapped to `int` — not yet implemented |
